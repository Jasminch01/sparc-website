    ...
    return (
        <div className={`my-5 relative ${poppins.className}`}>
            ...
            <div className="absolute left-0 right-0 bottom-0 overflow-hidden">
                <svg className="brightness-75 h-[340px]" viewBox="0 0 1440 320"><path fill="rgba(0, 0, 0, 0.55)" d="M0,0L0,60.9C300,-180,1140,400,480,80C640,107,800,213,960,245.3C1120,277,1280,235,1360,213.3L1440,192L1440,320L1360,320C1280,320,1120,320,960,320C800,320,640,320,480,320C320,320,160,320,80,320L0,320Z"></path></svg>
            </div>
