      ...
      <Container>
        <div className="mb-12 md:mb-16 lg:mb-20 px-4 md:px-6 lg:px-0">
          ...
          <div className="flex flex-wrap gap-3 md:gap-4 mb-8 md:mb-10 justify-center md:justify-start">
            <button className="px-4 md:px-6 py-2 cursor-pointer border-[#151515] border rounded-full bg-[#EBEBEB] transition text-sm md:text-base">
              Category 1
            </button>
            <button className="px-4 md:px-6 py-3 cursor-pointer border border-white rounded-full bg-[#EBEBEB] transition text-sm md:text-base">
              Category 2
            </button>
            <button className="px-4 md:px-6 py-3 cursor-pointer border border-white rounded-full bg-[#EBEBEB] transition text-sm md:text-base">
              Category 3
