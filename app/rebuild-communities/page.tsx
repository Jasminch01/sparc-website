                ...
                <section className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8 mb-8 sm:mb-10">
                    ...
                    <div>
                        <div className="bg-[#303030] text-white px-4 py-2 inline-block mb-4 sm:mb-6">
                            <h3 className={`text-xs sm:text-sm font-semibold tracking-wide ${poppins.className}`}>HIGHLIGHT</h3>
                        </div>
                        {data.filter(item => item.category === "highlight").map((item, index) => (
                            <div key={index} className="mb-6 sm:mb-8">
                                <div className="relative w-full h-[250px] sm:h-[300px] md:h-[400px] mb-3 sm:mb-4">
                                    <Image
                                        src={item.img}
                                        alt={item.title}
                                        fill
                                ...
                                <h2 className={`text-lg sm:text-xl md:text-2xl font-bold mb-2 sm:mb-3 ${poppins.className}`}>
                                    {item.title}
                                </h2>
                                <p className={`text-xs sm:text-sm text-gray-600 mb-3 sm:mb-4 ${poppins.className}`}>
                                    {item.date}
                                </p>
                                <p className={`text-sm sm:text-base text-justify mb-3 sm:mb-4 leading-relaxed ${antiquaFont.className}`}>
                                    {item.des}
                                </p>
                                <Link
                                    href={`/update/${item.title.replace(/\s+/g, '-').toLowerCase()}`}
                                    className={`text-xs sm:text-sm font-medium flex items-center gap-2 hover:text-[#FF951B] transition-colors ${poppins.className}`}>
                                    Read More <span>→</span>
                                </Link>
                            </div>
                        ))}
                    ...
                    <div>
                        <div className="bg-[#E5E5E5] px-4 py-2 inline-block mb-4 sm:mb-6">
                            <h3 className={`text-xs sm:text-sm font-semibold tracking-wide ${poppins.className}`}>
                                FEATURED_STORIES
                            </h3>
                        </div>
                        <div className="space-y-4 sm:space-y-6">
                            {data.filter(item => item.category === "FEATURED_STORIES").map((item, index) => (
                                <div key={index} className="border-b border-gray-400 pb-4 sm:pb-6 last:border-b-0">
                                    <div className="relative w-full h-[200px] sm:h-[250px] mb-3 sm:mb-4">
                                        <Image
                                            src={item.img}
                                            alt={item.title}
                                            fill
                                    ...
                                    <h3 className={`text-base sm:text-lg md:text-xl font-bold mb-2 ${poppins.className}`}>
                                        {item.title}
                                    </h3>
                                    <p className={`text-xs sm:text-sm text-gray-600 mb-2 sm:mb-3 ${antiquaFont.className}`}>
                ...
                <section className="my-12 sm:my-16 md:my-20">
                    <div className='text-center max-w-3xl mx-auto mb-8 sm:mb-10'>
                        ...
                        <p className={`mb-3 sm:mb-4 text-base sm:text-lg ${antiquaFont.className} text-gray-500`}>
                            Each update reflects our commitment to accountability, collaboration, and positive impact across Indigenous regions.
                        </p>
                    </div>
                    ...
                    <div className='grid grid-cols-1 sm:grid-cols-3 py-6 sm:py-8 md:py-10 gap-2 sm:gap-0'>
                        {projectsCategory.map((cat, index) => (
                            <div key={index} className='flex items-center justify-center lg:border-b-2 lg:border-gray-300'>
                                <button
                            ...
                            <div key={index} className='relative'>
                                <div className='border-2 border-gray-300 p-3 sm:p-4 rounded-lg hover:shadow-lg transition-shadow lg:h-[550px] '>
                                    ...
                                    <div className='mt-4 sm:mt-5 space-y-2 sm:space-y-3'>
                                        <h2 className={`${poppins.className} text-base sm:text-lg font-semibold`}>
                                            {project.title}
                                        </h2>
                                        ...
                                        <div className='flex flex-wrap items-center gap-2 sm:gap-3 text-[#6B6B6B] text-xs'>
                                            <p className={`font-bold ${project.status === 'Ongoing' ? 'text-[#F26522]' : 'text-[#018F44]'} ${poppins.className}`}>
                                                {project.status}
                                            </p>
            ...
            <Container>
                <section className="my-12 sm:my-16 md:my-20">
                    <div className='text-center max-w-3xl mx-auto mb-8 sm:mb-10'>
                        ...
                        <p className={`mb-3 sm:mb-4 text-base sm:text-lg ${antiquaFont.className} text-gray-500`}>
                            Explore our latest gatherings, campaigns, and community programs supporting Indigenous voices
                        </p>
                    </div>
                            ...
                            <div key={index} className='relative'>
                                <div className='border-2 border-gray-300 p-3 sm:p-4 rounded-lg hover:shadow-lg transition-shadow lg:h-[550px]'>
                                    ...
                                    <div className='mt-4 sm:mt-5 space-y-2 sm:space-y-3'>
                                        ...
                                        <div className='flex flex-wrap items-center gap-2 sm:gap-3 text-[#6B6B6B] text-xs'>
                                            <p className={`font-bold ${project.status === 'Upcoming' ? 'text-[#36133B]' : 'text-[#018F44]'} ${poppins.className}`}>
                                                {project.status}
                                            </p>
                                            <span className="hidden sm:inline">|</span>
                                            <p className={`${poppins.className}`}>{project.date}</p>
