...
const BlogPage = () => {
    ...
    return (
        <Container>
            {/* BreadCrump */}
            <div className={`flex items-center gap-5 my-10 ${poppins.className} text-sm`}>
            ...
            <div className="max-w-5xl mx-auto py-5 mb-15">
                <h1 className={`text-4xl font-bold mb-5 ${poppins.className}`}>{blog.title}</h1>
                ...
                />
                <p className={`text-gray-700 ${antiquaFont.className} `}>{blog.longdes}</p>
            </div>
        </Container>
    );
};
